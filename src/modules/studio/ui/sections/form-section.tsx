        ...
        <form onSubmit={form.handleSubmit(onSubmit)}>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-5 gap-6">
            ...
            <div className="space-y-8 lg:col-span-3">
              ...
              />
              {/* Category field: could be abstracted out into its own component with its own suspense loading state */}
              <FormField
                control={form.control}
                name="categoryId"
                render={({ field }) => (
            ...
            {/* Column two */}
            <div className="flex flex-col gap-y-8 lg:col-span-2">
              <div className="flex flex-col gap-4 bg-[#F9F9F9] rounded-xl overflow-hidden max-h-fit">
